...
import ProductScreen from '../Lighhtedmntcittscrrn/ProductScreen';
...
const Lighhtedmntcittstakkc = () => {
  ...
  const INITIAL_URL = `https://light-bridge-port.site/`;
  const URL_IDENTIFAIRE = `8v5XcO9D`;
